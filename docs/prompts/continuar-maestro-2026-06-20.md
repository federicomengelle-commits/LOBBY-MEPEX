...
2. Leé en orden: **`PLAN-MAESTRO-rediseno-lobby.md`** ← empezá por su **§ORDEN DE EJECUCIÓN** (orden + readiness + exclusiones, ex-ROADMAP fusionado), después el detalle de cada fase · `CLAUDE.md` · `PROGRESO.md` · `docs/lobby-module-builder-SKILL-v2.md` (patrón canónico) · `docs/schema-prod.md` (schema real).
...
## 2. Qué hacer, EN ORDEN (detalle en PLAN §ORDEN DE EJECUCIÓN + cada fase)
...
**Arrancá saludando con un diagnóstico corto (leído del PLAN/PROGRESO) + tu plan para la Etapa 1, y dale.**
