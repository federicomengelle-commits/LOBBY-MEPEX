...
- **3b.2 proveedores UUID**: `compras.js` opera sobre `compras_proveedores` (bigint) vs `proveedor` (uuid) el resto del sistema. Hay un parche de traducción (`api.js:4159-4178`). Pasada dedicada, all-or-nothing, riesgosa (ver [[project_finanzas_refactor_handoff]] §3b.2).
