...
| **T4.3** | `API.anularCobro` completo | JS | ⬜ | **subió de prioridad** (salió de T4.18): hoy "anular→regenerar" es **inalcanzable por la UI** en los 3 flujos con índice — ver la nota al pie |
...
## ⚠️ Hallazgo abierto que atraviesa T4.2 · T4.18 · T4.3
