...
const Data = {
    ...
    categories: [
        {
            ...
            color: '#00A9C1',
            modules: [
                { id: 'lobby', shortName: 'Lobby', icon: '<svg viewBox="0 0 24 24"><svg x="2" y="2" width="20" height="20" viewBox="694 812 7400 7400" preserveAspectRatio="xMidYMid meet"><polygon points="4602.93 3267.07 5351.47 3889.2 7328.81 2240.09 7328.81 994.34 4602.93 3267.07" fill="#00A9C1"/><polygon points="1460.52 3137.38 3109.7 4512.49 1460.52 5887.36 1460.52 7133.35 3856.65 5135.28 7328.81 8030.66 7328.81 6784.47 1460.52 1891.47 1460.52 3137.38" fill="#00A9C1"/></svg></svg>' },
    ...
    modules: {
        ...
        crm: {
            ...
            name: 'CRM',
            shortName: 'CRM',
            icon: '<svg viewBox="0 0 24 24"><rect x="1.5" y="1.5" width="21" height="21" rx="6" fill="#F28D15" fill-opacity="0.14"/><g fill="none" stroke="#F28D15" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-2"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/></g></svg>',
        ...
        cotizador: {
            ...
            name: 'Cotizador',
            shortName: 'Cotizador',
            icon: '<svg viewBox="0 0 24 24"><rect x="4.5" y="2.5" width="15" height="19" rx="2.5" fill="#00A9C1"/><rect x="6.8" y="4.6" width="10.4" height="3.4" rx="1" fill="#D6F4F8"/><rect x="7.1" y="10.2" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="10.75" y="10.2" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="14.4" y="10.2" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="7.1" y="13.7" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="10.75" y="13.7" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="14.4" y="13.7" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="7.1" y="17.2" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="10.75" y="17.2" width="2.5" height="2.5" rx="0.7" fill="#fff"/><rect x="14.4" y="17.2" width="2.5" height="2.5" rx="0.7" fill="#F28D15"/></svg>',
        ...
        calendario: {
            ...
            icon: '<svg viewBox="0 0 24 24"><rect x="3.5" y="5" width="17" height="15" rx="2.5" fill="#fff"/><path d="M3.5 7.5A2.5 2.5 0 0 1 6 5H18A2.5 2.5 0 0 1 20.5 7.5V9H3.5Z" fill="#00A9C1"/><rect x="7" y="3.2" width="2" height="3.6" rx="1" fill="#0097ad"/><rect x="15" y="3.2" width="2" height="3.6" rx="1" fill="#0097ad"/><rect x="9.5" y="12" width="5" height="5" rx="1.2" fill="#F28D15"/></svg>',
            description: 'Vista de calendario operativo: armados, eventos y desarmes.',
            status: 'active',
            color: '#00CC88',
            order: 3.9,
            sections: [],
        ...
        proyectos: {
            ...
            name: 'Proyectos',
            shortName: 'Proyectos',
            icon: '<svg viewBox="0 0 24 24"><path d="M3 7a2 2 0 0 1 2-2h3.5l2 2H19a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z" fill="#00CC88"/><rect x="6.5" y="11" width="11" height="7.5" rx="1" fill="#fff"/><rect x="8.3" y="13" width="5.5" height="1.3" rx="0.6" fill="#00CC88"/><rect x="8.3" y="15.4" width="7.4" height="1.3" rx="0.6" fill="#9be8c8"/></svg>',
        ...
        eventos: {
            ...
            name: 'Eventos',
            shortName: 'Eventos',
            icon: '<svg viewBox="0 0 24 24"><rect x="3.5" y="6" width="17" height="12" rx="2.5" fill="#F28D15"/><line x1="13" y1="7" x2="13" y2="17" stroke="#fff" stroke-width="1.3" stroke-dasharray="1.5 1.7"/><circle cx="8.5" cy="12" r="2" fill="#fff"/></svg>',
        ...
        finanzas: {
            ...
            name: 'Finanzas',
            shortName: 'Finanzas',
            icon: '<svg viewBox="0 0 24 24"><path d="M9.2 4h5.6l-1.3 3h-3Z" fill="#C9923F"/><path d="M10.3 7C7.6 8.7 5.6 11.6 5.6 15A4.4 4.4 0 0 0 10 19.4h4A4.4 4.4 0 0 0 18.4 15c0-3.4-2-6.3-4.7-8Z" fill="#E0A96D"/><path d="M12 11v6.3M13.7 12.3c-.3-.7-1-1-1.7-1-1 0-1.7.6-1.7 1.4 0 1.9 3.4.9 3.4 2.9 0 .8-.8 1.4-1.7 1.4-.8 0-1.5-.3-1.8-1" stroke="#7A5320" stroke-width="1.3" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        ...
        contabilidad: {
            ...
            name: 'Contabilidad',
            shortName: 'Contab.',
            icon: '<svg viewBox="0 0 24 24"><rect x="10.8" y="4" width="2.4" height="15" rx="1" fill="#4A90D9"/><rect x="8" y="18.4" width="8" height="2.2" rx="1.1" fill="#4A90D9"/><rect x="5" y="6.4" width="14" height="1.8" rx="0.9" fill="#4A90D9"/><circle cx="12" cy="5.3" r="1.6" fill="#F28D15"/><path d="M5.8 7.3 3.4 12h4.8Z" fill="#7FB3E8"/><path d="M18.2 7.3 15.8 12h4.8Z" fill="#7FB3E8"/></svg>',
        ...
        costos: {
            ...
            name: 'Costos',
            shortName: 'Costos',
            icon: '<svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="2.5" fill="#C08A4A"/><rect x="5" y="6" width="14" height="12" rx="1" fill="#F3E2C7"/><line x1="5" y1="9.2" x2="19" y2="9.2" stroke="#9A6B33" stroke-width="1"/><line x1="5" y1="12" x2="19" y2="12" stroke="#9A6B33" stroke-width="1"/><line x1="5" y1="14.8" x2="19" y2="14.8" stroke="#9A6B33" stroke-width="1"/><circle cx="8" cy="9.2" r="1.25" fill="#00A9C1"/><circle cx="11" cy="9.2" r="1.25" fill="#00A9C1"/><circle cx="14" cy="12" r="1.25" fill="#F28D15"/><circle cx="17" cy="12" r="1.25" fill="#F28D15"/><circle cx="7" cy="14.8" r="1.25" fill="#E2445C"/><circle cx="15" cy="14.8" r="1.25" fill="#E2445C"/></svg>',
        ...
        rendimiento: {
            id: 'rendimiento',
            name: 'Rendimiento por evento',
            shortName: 'Rendimiento',
            icon: '📊',
            description: 'Planilla de costos por evento (jornales, fletes, proveedores, seguros, comida) y dashboard de ganancia. Solo admin.',
            status: 'active',
            color: '#4A90D9',
            order: 12.7,
            sections: [
                { id: 'planilla', name: 'Planilla', icon: '🧾', description: 'Costos del evento por categoría; cada pago genera un egreso', fields: [] },
                { id: 'ganancia', name: 'Ganancia', icon: '💰', description: 'Cobrado + Facturado − Costos − Materiales = Ganancia y margen', fields: [] },
            ],
            connections: [
