...
- **Sesión 2026-06-21 (Facturación recurrente / carga masiva) — CONSTRUIDO + VERIFICADO EN PREVIEW · ⏳ falta pull + 1ª emisión real de lote de Fede**:
  ...
  - **Pendientes que NO se tocaron** (siguen del handoff): rediseño de la solapa Facturación (repaso de marca); NC/ND real sin emitir; gaps de Reportes (Rent.Cliente/Proyecto no filtran por período; Rentab.% cliente ~100% sin costo atribuido) — **decisión de diseño pendiente de Fede** antes de tocar.
