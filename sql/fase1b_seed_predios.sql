-- ═══════════════════════════════════════════════════════════════════
-- FASE 1B — Seed de predios (locaciones de eventos).
-- ═══════════════════════════════════════════════════════════════════
-- INDEPENDIENTE de fase1_unificacion_uuid.sql: se puede correr antes,
-- después o en paralelo, ya que `predios` no tiene FKs cruzadas con
-- ninguna de las tablas que toca la migración de UUID.
--
-- Este archivo es una copia tal-cual de sql/predios.sql, con un
-- COUNT(*) al final para verificar el seed.
--
...
-- ═══════════════════════════════════════════════════════════════════
-- Esperado: 37 filas (la lista deduplicada de Notion).
